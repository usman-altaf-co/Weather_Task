...
class WeatherDataProcessor:
    ...
    def process_weather_data(self):
        ...
        if args.year_month:
            ...
            month_weather_readings = self.weather_data_loader.load_weather_readings(year, month)
            month_weather_averages = WeatherDataAnalyzer.calculate_month_averages(month_weather_readings)
